  ...
  return (
    <section className='bg-primary flex flex-col justify-center items-center pt-[100px] text-white w-[100vw]'>
      <div className='sm:w-[800px] w-[90%] bg-dimWhite py-10  rounded-lg'>
        <h3 className='font-[700] text-[26px]'>Get early access today</h3>
        <p className='font-[400] text-[14px] py-5 sm:px-20 px-5'>It only takes a minute to sign up and our free starter tier is extremely generous. If you have ant questions, our support team would be happy to help you.</p>
        <form>
