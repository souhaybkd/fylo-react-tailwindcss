  ...
  return (
    <section className='bg-primary w-[100vw] flex justify-center items-centre sm:flex-row flex-col px-5 pt-4'>
      ...
      <div className='flex  flex-col text-left justify-center ss:pl-8	ss:pt-0 pt-10'>
        <h2 className='text-white font-[700] xs:text-[42px] text-[20px] leading-14'>Stay productive, <br className='ss:block hidden'/>wherever you are </h2>
        <p className='text-white font-[400] ss:text-[16px] text-[14px] py-4'>Never let location be an issue when accessing your files. Fylo has you<br/>covered for all of you file storage needs.</p>
        <p className='text-white font-[400] ss:text-[16px] text-[14px]'>Securely share files and folders with friends, family and colleagues for live<br/>collaboration. No email attachments required.</p>
